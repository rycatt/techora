...
export default function ProductCard({
  ...
  return (
    <div
      className={`w-72 rounded-xl shadow-lg p-4 ${bgColor} cursor-pointer ${rotation} ${positionClasses} hover:scale-105 hover:shadow-xl transition-transform`}
    >
      ...
      <p className="text-sm text-gray-300/80 font-semibold mt-12">{description}</p>
    </div>
  );
}
