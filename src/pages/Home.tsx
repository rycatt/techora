  ...
  return (
    <main className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-center gap-8 mt-12">
      ...
      <div className="text-center px-4 pt-20 pb-16">
        ...
        <p className="mt-6 mx-auto w-full max-w-[85%] sm:max-w-[75%] md:max-w-xl lg:max-w-2xl text-base sm:text-lg md:text-xl tracking-tight text-gray-400">
          We know hardware inside and out. Find reliable parts for gaming PCs, work computers, or
          any custom build you have in mind.
        </p>
